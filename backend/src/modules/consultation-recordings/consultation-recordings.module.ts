...
import { ConsultationRecordingsCleanupScheduler } from './consultation-recordings-cleanup.scheduler';
...
@Module({
  ...
  providers: [ConsultationRecordingsService, ConsultationRecordingsCleanupScheduler],
