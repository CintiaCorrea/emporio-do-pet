// FORMAS DE RECEBIMENTO — aba de Configuração de vendas desde 17/09/2026. É AQUI que se edita o
// desconto permitido por forma (o "% de desconto" que a Cintia procurava): cada forma tem o seu.
"use client";
...
export default function FormasDeRecebimento() {
