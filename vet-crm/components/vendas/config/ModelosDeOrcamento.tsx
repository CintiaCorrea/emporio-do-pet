// MODELO DE ORÇAMENTO — agora uma aba de Configuração de vendas (Cintia, 17/09/2026: "não pode
// juntar tudo e colocar dentro de configuração de vendas?"). Era uma entrada própria no menu.
"use client";
...
export default function ModelosDeOrcamento() {
