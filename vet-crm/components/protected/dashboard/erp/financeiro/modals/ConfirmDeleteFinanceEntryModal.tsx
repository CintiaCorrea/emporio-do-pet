...
const ConfirmDeleteFinanceEntryModal = ({ isOpen, title, subtitle, onClose, onConfirm }: Props) => {
        ...
        <div className="p-6">
          <div className="flex items-start gap-3 p-4 rounded-2xl bg-red-50 border border-red-100">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mt-1">{subtitle ?? "Esta ação não pode ser desfeita."}</p>
            </div>
          </div>
...
export default ConfirmDeleteFinanceEntryModal;
