...
const ConfirmDeleteColumnModal = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Confirmar exclusão de coluna"
    >
          ...
          <div className="flex items-start gap-3 p-4 rounded-2xl bg-red-50 border border-red-100">
            ...
            <div className="flex-1">
              <p className="text-gray-900 font-semibold leading-snug">
                ...
                <span className="text-red-700">“{columnName}”</span>?
              </p>
              <p className="text-sm text-gray-600 mt-1">
                Esta ação não pode ser desfeita. Os cards dessa coluna serão removidos.
              </p>
            </div>
          </div>
