        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              Enviar outro email
            </button>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    Enviaremos um link seguro para seu email. Clique nele para 
