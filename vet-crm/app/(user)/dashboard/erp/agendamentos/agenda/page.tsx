...
export default function AgendaPage() {
  ...
  return (
    <div className="p-4 min-h-screen bg-[#F6F2EA]">
      ...
      {confirmData && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" style={{ background: "rgba(20,35,40,.28)" }} {...fundoDeModal(() => !sending && setConfirmData(null))}>
      ...
      {cancelData && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" style={{ background: "rgba(20,35,40,.28)" }} {...fundoDeModal(() => !sending && setCancelData(null))}>
