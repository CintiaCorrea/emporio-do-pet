...
export default function ConfigModelosDocumentoPage() {
  ...
  async function addModelo() {
    ...
    try {
      const r = await fetch(`/api/listas`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ lista: "documento_modelo", valor: JSON.stringify({ nome, corpo: "" }) }) });
