...
const ITEMS: Item[] = [
  ...
  { href: "/dashboard/configuracoes/modelos-documento", title: "Modelos de Documento", description: "Modelos de documento da ficha do pet (editáveis)", Icon: LuFileText, group: "CADASTROS" },
